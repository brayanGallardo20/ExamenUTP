...
namespace CCommon
{
    public class UtilityResponse<T>
    {
        ...
        public ResponseBase<T> SetResponseBaseForValidationAlumnString(T obj)
        {
            ResponseBase<T> response = new ResponseBase<T>();
            response.Code = ConfigurationLib.InvalidParametersCode;
        ...
        public ResponseBase<T> SetResponseBaseForValidationCourseString(T obj)
        {
            ResponseBase<T> response = new ResponseBase<T>();
            response.Code = ConfigurationLib.InvalidParametersCode;
        ...
        public ResponseBase<T> SetResponseBaseForValidationNoteString(T obj)
        {
            ResponseBase<T> response = new ResponseBase<T>();
            response.Code = ConfigurationLib.InvalidParametersCode;
            response.Message = "No tiene ninguna nota asignada";
            return response;
        }
        ...
        public ResponseBase<T> SetResponseBaseForProcessStateNoDataFound()
        {
            ResponseBase<T> response = new ResponseBase<T>();
            response.Code = ConfigurationLib.DataNotFoundErrorCode;
            response.Message = ConfigurationLib.ProcessStateDataNotFoundMessageES;
            response.List = new List<T>();
            return response;
        }
        ...
        public ResponseBase<T> SetResponseBaseFunctionalErrors(ValidationResult results)
        {
            ...
            foreach (var failure in results.ErrorMessage)
            {
                listErrors.Add(failure.ToString());
            }
            response.FunctionalErrors = listErrors;
            return response;
        }

        public ResponseBase<T> SetResponseBaseFunctionalErrors()
        {
            ResponseBase<T> response = new ResponseBase<T>();
            response.Code = ConfigurationLib.DataNotFoundErrorCode;
            response.Message = ConfigurationLib.DataNotRegisteredES;
            response.List = new List<T>();
            return response;
        }
    }
