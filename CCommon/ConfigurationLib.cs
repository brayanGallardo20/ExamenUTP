...
namespace CCommon
{
    public static class ConfigurationLib
    {
        ...
        public static string ProcessStateDataNotFoundMessageES { get { return "No se encontro el ESTADO PROCESO (TBL_SLI_PROCESSSTATE) del módulo actual"; } }

        public static string DataNotRegisteredES { get { return "No se registraron los datos"; } }
        ...
        public static string DataExistsMessage { get { return "Lo sentimos, ya existe el registro"; } }
        ...
        public static string InvalidParametersMessageES { get { return "Los parámetros ingresados no son los correctos"; } }
